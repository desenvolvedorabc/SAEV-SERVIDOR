...
export class ReleaseResultsService {
  ...
  async findTestsByStudent(idTest: number, idStudent: string) {
    return this.studentTestRepository
      ...
      .select([
        "ALUNO_TESTE.ALT_FINALIZADO, ALUNO_TESTE.ALT_DT_ATUALIZACAO, ALUNO_TESTE.ALT_BY_HERBY, USUARIO.USU_NOME, ALUNO_TESTE.ALT_JUSTIFICATIVA, schoolClass.TUR_ID,ALUNO_TESTE_RESPOSTA.*",
      ])
