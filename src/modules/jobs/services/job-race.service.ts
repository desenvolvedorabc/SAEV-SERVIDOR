...
export class JobRaceService {
  ...
  async generateReportEditionsByCounty(
    ...
    const reportRaces =
      await this.jobRaceRepository.getReportRaceGroupedByCounty(
        countyId,
        testId,
        type,
      )
  ...
  async generateReportEditionsBySchool(
    ...
    const reportRaces =
      await this.jobRaceRepository.getReportRaceGroupedByTestAndSchoolClass(
        schoolId,
        testId,
        type,
      )
  ...
  async generateByMunicipalityRegional(
    ...
    const reportRaces =
      await this.jobRaceRepository.getReportEditionGroupedByMunicipalityRegional(
        schoolId,
        testId,
        type,
      )
