...
export class ReportsController {
  ...
  performanceHistory(
    ...
    return this.reportsService.performanceHistory(paginationParams, user)
  }
  ...
  evolutionaryLineOfReading(
    ...
    return this.reportsService.evolutionaryLineOfReading(paginationParams, user)
  }
  ...
  async generateCsvPerformanceHistory(
    ...
    const data = await this.reportsService.generateCsvPerformanceHistory(
      paginationParams,
      user,
    )
  ...
  @ApiBearerAuth()
  @Get('/school-absences')
  async report(@CurrentUser() user: User, @Query() params: PaginationParams) {
    return this.reportsService.schoolAbsences(params, user)
  }

  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @Get('/school-absences/csv')
  async generateCsvOfReport(
    @CurrentUser() user: User,
    @Res() response: Response,
    @Query() params: PaginationParams,
  ) {
    const data = await this.reportsService.generateCsvSchoolAbsences(
      params,
      user,
    )
