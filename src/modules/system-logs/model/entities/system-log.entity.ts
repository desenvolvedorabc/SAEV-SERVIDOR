...
export class SystemLogs {
  ...
  @Column({
    comment:
      'Campo destinado a informar o nome da entidade que está sendo gerado o log',
  })
  nameEntity: string
  ...
  @Column({
    ...
    nullable: true,
    comment:
      'Campo destinado a informar o estado inicial do dado que será gerado o log',
  })
  stateInitial: string
  ...
  @Column({
    type: 'longtext',
    comment:
      'Campo destinado a informar o estado final do dado que será gerado o log',
  })
  stateFinal: string
